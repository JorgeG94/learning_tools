...
The canonical source is untouched: OpenACC resolves these references through
the host present-table and never hits the bug.
...
when arrays are attached by an earlier `enter data`) the clause is a present-table
