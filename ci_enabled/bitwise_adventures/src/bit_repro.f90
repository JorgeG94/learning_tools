...
public :: exp_reprod, log_reprod, pow_reprod, pow_reprod_explog, cuberoot, erfc_reprod, erfc_reprod_bf
...
elemental function erfc_reprod_bf(x) result(ec)
  ...
  real(wp), parameter :: two_m64 = 2.0_wp**(-64)
  ...
  call two_prod(p, log2e_hi, ph, pt)
  h = -ph
  l = -(pt + p*log2e_lo)
  n32 = nint(h * 32.0_wp)
